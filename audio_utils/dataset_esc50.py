...
from utilities_esc50 import (create_folder, get_filename, create_logging,
...
def pack_waveforms_to_hdf5(args):
    ...
    clip_samples = config_esc50.clip_samples
    classes_num = config_esc50.classes_num
    sample_rate = config_esc50.sample_rate
    id_to_ix = config_esc50.id_to_ix
    ...
    with h5py.File(waveforms_hdf5_path, 'w') as hf:
        ...
        hf.create_dataset('target', shape=((audios_num,)), dtype=np.int)
...
if __name__ == '__main__':
    ...
    # parser_split = subparsers.add_parser('split_unbalanced_csv_to_partial_csvs')
    # parser_split.add_argument('--unbalanced_csv', type=str,
    #                           # required=True,
    #                           help='Path of unbalanced_csv file to read.',
    #                           default='/media/storage/home/22828187/datasets/AudioSet/metadata/unbalanced_train_segments.csv')
    # parser_split.add_argument('--unbalanced_partial_csvs_dir', type=str,
    #                           # required=True,
    #                           help='Directory to save out split unbalanced partial csv.',
    #                           default='/media/storage/home/22828187/datasets/AudioSet/metadata/unbalanced_partial_csvs')
    #
    # parser_download_wavs = subparsers.add_parser('download_wavs')
    # parser_download_wavs.add_argument('--csv_path', type=str,
    #                                   required=False,
    #                                   default="/media/storage/home/22828187/datasets/AudioSet/metadata/eval_segments.csv",
    #                                   help='Path of csv file containing audio info to be downloaded.')
    # parser_download_wavs.add_argument('--audios_dir', type=str,
    #                                   required=False,
    #                                   default="/media/storage/home/22828187/datasets/AudioSet/audios/eval_segments",
