...
from utilities_fsd50k import (create_folder, get_filename, create_logging,
    float32_to_int16, pad_or_truncate, read_metadata)
import config_fsd50k
...
def pack_waveforms_to_hdf5(args):
    ...
    clip_samples = config_fsd50k.clip_samples
    classes_num = config_fsd50k.classes_num
    sample_rate = config_fsd50k.sample_rate
    id_to_ix = config_fsd50k.id_to_ix
