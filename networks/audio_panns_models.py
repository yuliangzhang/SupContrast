...
from audio_utils.pytorch_utils import do_mixup, interpolate, pad_framewise_output
...
class Cnn6_Softmax(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin,
                 fmax, classes_num):

        super(Cnn6_Softmax, self).__init__()
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        # print("model pred: ", clipwise_output)
        # print("softmax pred: ", torch.softmax(self.fc_audioset(x), dim=1))
...
class LinearClassifier(nn.Module):
    """Linear classifier"""
    def __init__(self, name='Cnn6_Softmax', num_classes=10):
